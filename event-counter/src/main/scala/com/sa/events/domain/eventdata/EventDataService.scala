...
//  def execute[F[_]](blocker: Blocker)(implicit F: ConcurrentEffect[F]
//                                      , timer: Timer[F]
//                                      , contextShift: ContextShift[F])
//           = {
...
//                        , contextShift: ContextShift[F])
////            : Stream[F,Unit]
//    : Stream[F,Option[EventCountState]]
//   = {
//    /*
...
//  }
//
//  private def pipeRef(eventCountStateRef: Ref[F,EventCountState])
